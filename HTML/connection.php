...
if($user['partner'] == $user['id']){
    ...
    foreach($connection_requests as $id){
        ...
        "<div class='col-3'>
            ...
            <div class='row'>
            <a href=../PHP/modify_connections.php?type=1&from_id=" . strval($id) . "&to_id=".strval($user['id'])."><img src='../assets/icons/accept.png' class='col-sm-3 offset-sm-3'></a>
            <a href=../PHP/modify_connections.php?type=0&from_id=" . strval($id) . "><img src='../assets/icons/reject.png' class='col-sm-3'></a></div>
            </div>
        </div>";
    }
